...
<head>
    ...
    <!-- Sweetalert -->
    <link rel="stylesheet" href="includes/sweetalert-master/dist/sweetalert.css">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Mg-PTC</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="#" >Home Monitor &amp; Review</a>
                    </li>
                    <li>
                        <a href="#">Scam Sites</a>
                    </li>
                    <li>
                        <a href="#">Add New PTC Site</a>
                    </li>
                    <li>
                        <a href="#">F.A.Q</a>
                    </li>
